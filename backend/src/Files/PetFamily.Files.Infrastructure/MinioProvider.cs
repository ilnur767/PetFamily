...
public class MinioProvider : IFileProvider
{
    ...
    public async Task<Result<string, Error>> UploadFile(FileDataDto fileData, CancellationToken cancellationToken)
    {
        try
        {
    ...
    public async Task<Result<IReadOnlyCollection<string>, Error>> UploadFiles(IEnumerable<FileDataDto> filesData, string bucketName,
    ...
    public async Task<UnitResult<Error>> DeleteFile(FileInfoDto file,
        CancellationToken cancellationToken)
    {
        try
        {
    ...
    private async Task<Result<string, Error>> CreateFile(FileDataDto file, SemaphoreSlim semaphore,
        CancellationToken cancellationToken)
    {
        await semaphore.WaitAsync(cancellationToken);
